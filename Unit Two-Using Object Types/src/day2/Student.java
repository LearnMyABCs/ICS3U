...
public class Student {
    // Data members/instance variables/attributes (define current state of an object)
    private String name;
    private int age;
    ...
    // Constructor -> create the object and set the initial state (give the attribute initial values)
