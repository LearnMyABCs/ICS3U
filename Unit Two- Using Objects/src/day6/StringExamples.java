...
public class StringExamples {
    public static void main(String[] args) {
        ...
        System.err.println(s1==s2);  // == chekcs the memory location for the variables to see if they are the 
        ...
        System.out.println(str1 == str2);       //false becayse new String() creats a new object for each
